...
define('USER_PASSWORD_VERIFY','Confirmation de mot de passe');
...
define('REQUIRE_POSTAL_CODE', 'Le code postal est obligatoire');
define('REQUIRE_CITY', 'La ville est obligatoire');
...
define('DELETE_ACCOUNT_CONFIRMATION', 'Êtes-vous sûr de vouloir supprimer votre compte ?');
