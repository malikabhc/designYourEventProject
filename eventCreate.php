...
include_once 'controllers/eventCreateCtrl.php';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body class="<?= $displayEventUser->className ?>">
        <div class="container">
            <h1 class="text-center font-weight-bold mt-3 pt-5 pb-5"><?= $displayEventUser->eventName ?></h1>
            <p  class="text-center"><?= $displayEventUser->contributorFirstname . ' ' . $displayEventUser->contributorLastname ?></p>
            <p  class="text-center"><?= $displayEventUser->eventDescription ?></p>
            ...
            ?>
            <p  class="text-center"><?= $displayEventUser->address ?></p>
            ...
            <div class="text-center">
                ...
                <?php if ($displayEventUser->snapchatLink !== '') { ?>
                    <a href="<?= $displayEventUser->snapchatLink ?>"><i class="fab fa-snapchat-square fa-2x ml-5"></i></a>
                <?php } ?>
            </div>
        </div>
        <footer>
            <!-- Copyright -->
            <div class="text-center mt-3">© <?= YEAR ?>- <?= EVENT_CREATED_BY ?><span class="font-title size">Design-your-Event</span></div>
            <!-- JQuery -->
